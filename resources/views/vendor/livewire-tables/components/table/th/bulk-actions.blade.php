            ...
            <input
                ...
                {{
                    $attributes->merge($bulkActionsThCheckboxAttributes)->class([
                        ...
                        'rounded shadow-sm transition duration-150 ease-in-out focus:ring focus:ring-opacity-50 w-[20px] h-[20px] ' => $isTailwind && (($bulkActionsThCheckboxAttributes['default'] ?? true) || ($bulkActionsThCheckboxAttributes['default-styling'] ?? true)),
