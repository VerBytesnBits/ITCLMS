                ...
                <div class="p-6">
                    <form wire:submit.prevent="save" class="space-y-4">
                        <div>
                            ...
                            <select wire:model="system_unit_id" class="w-full rounded border-gray-300">
                                ...
                                @foreach ($systemUnits as $unit)
                                    <option value="{{ $unit->id }}">{{ $unit->name ?? 'Unit #' . $unit->id }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select wire:model="room_id" class="w-full rounded border-gray-300">
                                <option value="">-- None --</option>
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="color" class="w-full rounded border-gray-300">
                            @error('color')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
