<div>
    ...
    <flux:tooltip hoverable>
        <!-- View QR -->
        <flux:button x-data @click="$dispatch('open-qr-modal', { qr: '{{ Storage::url($qr_code_path) }}', serial: '{{ $serial_number }}' })" icon="qr-code" variant="primary" class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 
